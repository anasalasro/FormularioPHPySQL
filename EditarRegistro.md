...
$sentencia = $base_de_datos->prepare("SELECT id, nombre, edad, id_propietario FROM mascotas WHERE id = ?;");
...
<div class="row">
	<div class="col-12">
		...
		<form id="form-editar-mascotas" action="guardarDatosEditados.php" method="POST">
			...
			<div class="form-group">
				<label for="sel_propietarios">Propietario</label>
				<?php include_once "SelectPropietariosBd.php"?>
				<script>
					$("select#sel-propietarios").attr("form", "form-editar-mascotas");
					$("select#sel-propietarios").val("<?php echo $mascota->id_propietario; ?>");
				</script>
			</div>
            <?php
			if ($error != "") {
