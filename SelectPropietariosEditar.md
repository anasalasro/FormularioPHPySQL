# Código para el desplegable de los propietarios modificado para le opción de editar mascota ya que si dejamos la opción vacía por defecto nos da errores.
```php
